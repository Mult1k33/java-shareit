...
public class BookingController {
    ...
    @GetMapping("/owner")
    public ResponseEntity<Object> getByOwnerId(@RequestHeader("X-Sharer-User-Id") @Positive Long ownerId,
    ...
    @GetMapping
    public ResponseEntity<Object> getByBookerId(@RequestHeader("X-Sharer-User-Id") @Positive Long bookerId,
                                                @RequestParam(name = "state", defaultValue = "ALL")
                                                BookingState bookingState) {
